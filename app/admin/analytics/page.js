...
function computeMetrics(orders) {
    ...
    const getStageDelay = (getFrom, getTo) => {
        const delays = completedOrders
            ...
            .filter((t) => t > 0);
        const avg =
            delays.length > 0 ? delays.reduce((a, b) => a + b, 0) / delays.length / 60000 : 0;
    ...
    const breakdown = {
        ...
        confirmedToViewed: getStageDelay(
            (o) => o.adminProcessedAt,
            (o) => o.partnerViewedAt
        ),
        viewedToReady: getStageDelay(
            (o) => o.partnerViewedAt,
            (o) => o.readyAt
        ),
        readyToPickedUp: getStageDelay(
            (o) => o.readyAt,
            (o) => o.pickedUpAt
        ),
        pickedUpToDelivered: getStageDelay(
            (o) => o.pickedUpAt,
            (o) => o.deliveredAt
        ),
    };
    ...
    completedOrders.forEach((o) => {
        ...
        if (date) {
            ...
            profitByDate[date] =
                (profitByDate[date] || 0) + (o.finalTotal || o.total || 0) - orderItemAmount;
        }
    });
