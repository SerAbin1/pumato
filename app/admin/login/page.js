            ...
            >
                ...
                <div className="text-center mb-10">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl mb-6 shadow-2xl shadow-orange-900/40"
                    >
                        <Lock size={36} className="text-white" />
                    </motion.div>
                    <h1 className="text-4xl font-black text-white tracking-tight mb-2">Admin Login</h1>
                    <p className="text-gray-400 font-medium">Enter your credentials to access the dashboard</p>
                </div>
