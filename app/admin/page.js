                                ...
                                <div key={num} className={`bg-black/30 p-6 rounded-2xl border border-white/10 relative overflow-hidden ${banners[`banner${num}`]?.hidden ? 'opacity-50' : ''}`}>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <FormInput
                                            ...
                                            value={banners[`banner${num}`]?.title || ""}
                                            onChange={(e) => setBanners({ ...banners, [`banner${num}`]: { ...banners[`banner${num}`], title: e.target.value } })}
                                        />
                                        <FormInput
                                            label="Subtitle (e.g. Welcome Bonus)"
                                            value={banners[`banner${num}`]?.sub || ""}
                                            onChange={(e) => setBanners({ ...banners, [`banner${num}`]: { ...banners[`banner${num}`], sub: e.target.value } })}
                                        />
                                    </div>
                                </div>
                            ))}
