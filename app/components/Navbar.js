...
export default function Navbar() {
    ...
    const CommunityDropdown = () => {
        ...
        if (!whatsappGroups || whatsappGroups.length === 0) return null;
                    ...
                    {isCommunityOpen && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <button onClick={() => setIsCommunityOpen(false)} className="text-gray-500 hover:text-white"><X size={14} /></button>
                            </div>
