...
const TYPE_CONFIG = {
    ...
    laundry: {
        color: "blue",
        termsLink: "/terms/laundry",
        terms: [
            "PUMATO is a student-run laundry facilitation service",
            "Fabric damage claims must be raised within 24 hours of delivery",
            "Delicate or dry-clean-only items are handled at the customer's risk",
            "Pickup and delivery slots are subject to availability",
            "Lost items are compensated up to a fixed maximum liability amount",
...
const COLOR_CLASSES = {
    orange: {
        ...
        link: "text-orange-500/60 hover:text-orange-400",
    },
    green: {
        icon: "text-green-500/50",
        dot: "bg-green-500/30",
        link: "text-green-500/60 hover:text-green-400",
    },
    blue: {
                ...
                <div className="py-12 grid md:grid-cols-2 gap-12 border-b border-white/5">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <ShieldCheck size={14} className={colors.icon} />
                    ...
                    <div className="md:text-right flex flex-col md:items-end justify-center">
                        ...
                        <Link
                            ...
                            className={`inline-flex items-center gap-1.5 font-bold text-[10px] uppercase tracking-wider ${colors.link} transition-colors`}
                        >
