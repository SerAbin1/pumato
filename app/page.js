    ...
    return (
        <main className="min-h-screen w-full bg-black text-white selection:bg-orange-500 selection:text-white overflow-x-hidden">
                ...
                <div className="z-10 max-w-6xl flex flex-col items-center">
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            transition={{ delay: 1 }}
                        >
                            The <span className="text-white font-medium">Super-App</span> for Every
                            Hostel Need — Food, Laundry, and More, Delivered Fast.
                        </motion.p>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 md:gap-8 perspective-1000">
                        ...
                        <TiltCard className="relative h-[50vh] md:h-[70vh] w-full rounded-[2.5rem] overflow-hidden group border border-white/10 cursor-pointer">
                            <Link href="/delivery" className="block h-full w-full">
                                ...
                                <div className="absolute top-6 right-6 z-20">
                                    <div
                                        className={`px-3 py-1 rounded-full border backdrop-blur-md flex items-center gap-2 ${isFoodLive ? "bg-green-500/20 border-green-500/30 text-green-400" : "bg-red-500/20 border-red-500/30 text-red-400"}`}
                                    >
                                        <span
                                            className={`w-2 h-2 rounded-full ${isFoodLive ? "bg-green-500 animate-pulse" : "bg-red-500"}`}
                                        ></span>
                                        <span className="text-[10px] font-black uppercase tracking-widest">
                                            {isFoodLive ? "Live" : "Closed"}
                                        </span>
                                    </div>
                                </div>
                                <div className="absolute inset-x-0 bottom-0 z-20 p-6 md:p-10 mb-4">
                                    ...
                                    <p className="text-gray-300 text-sm md:text-base max-w-sm mb-4 line-clamp-2">
                                        Craving something good? We bring your favorites to your
                                        door.
                                    </p>
                        ...
                        <TiltCard className="relative h-[50vh] md:h-[70vh] w-full rounded-[2.5rem] overflow-hidden group border border-white/10 cursor-pointer">
                            <Link href="/grocery" className="block h-full w-full">
                                ...
                                <div className="absolute top-6 right-6 z-20">
                                    <div
                                        className={`px-3 py-1 rounded-full border backdrop-blur-md flex items-center gap-2 ${isGroceryLive ? "bg-green-500/20 border-green-500/30 text-green-400" : "bg-red-500/20 border-red-500/30 text-red-400"}`}
                                    >
                                        <span
                                            className={`w-2 h-2 rounded-full ${isGroceryLive ? "bg-green-500 animate-pulse" : "bg-red-500"}`}
                                        ></span>
                                        <span className="text-[10px] font-black uppercase tracking-widest">
                                            {isGroceryLive ? "Live" : "Closed"}
                                        </span>
                                    </div>
                                </div>
                                <div className="absolute inset-x-0 bottom-0 z-20 p-6 md:p-10 mb-4">
                                    ...
                                    <p className="text-gray-300 text-sm md:text-base max-w-sm mb-4 line-clamp-2">
                                        Essentials delivered in minutes. Milk, bread, snacks & more.
                                    </p>
                        ...
                        <TiltCard className="relative h-[50vh] md:h-[70vh] w-full rounded-[2.5rem] overflow-hidden group border border-white/10 cursor-pointer">
                            <Link href="/laundry" className="block h-full w-full">
                                ...
                                <div className="absolute inset-x-0 bottom-0 z-20 p-6 md:p-10 mb-4">
                                    ...
                                    <p className="text-gray-300 text-sm md:text-base max-w-sm mb-4 line-clamp-2">
                                        Look sharp, study hard. We handle the washing.
                                    </p>
            ...
            <section className="py-32 px-4 w-full bg-black relative overflow-hidden">
                <motion.div
                    style={{ y: yParallax }}
                    className="absolute -right-40 top-20 w-96 h-96 bg-purple-600/20 rounded-full blur-[120px] pointer-events-none"
                />
                <motion.div
                    style={{ y: yParallax }}
                    className="absolute -left-40 bottom-20 w-96 h-96 bg-orange-600/10 rounded-full blur-[120px] pointer-events-none"
                />
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        >
                            PUMATO aims to become a student-powered campus platform that solves
                            everyday university problems by providing fast, affordable, and reliable
                            services.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-center md:text-left mb-20">
                        {[
                            {
                                title: "Fast",
                                desc: "Delivery times optimized for campus layouts.",
                                icon: <Zap size={40} className="text-orange-500" />,
                            },
                            {
                                title: "Affordable",
                                desc: "Prices tailored for student budgets.",
                                icon: <Wallet size={40} className="text-orange-500" />,
                            },
                            {
                                title: "Reliable",
                                desc: "Trusted by thousands of students daily.",
                    ...
                    >
                        <span className="text-purple-400 font-bold tracking-[0.3em] text-sm uppercase">
                            Our Mission
                        </span>
                        <p className="text-white text-xl md:text-2xl mt-4 leading-relaxed font-medium max-w-3xl mx-auto">
                            Our mission is to provide fast and reliable campus deliveries, support
                            student needs, and create work opportunities for students through a
                            student-run service platform.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <footer className="py-24 text-center bg-black relative overflow-hidden">
                ...
                <div className="flex justify-center gap-6 mb-12">
                    <a
                        href="https://www.instagram.com/pumato_pu_?igsh=M2FjOHJ2aW56bmRs"
                        target="_blank"
                        rel="noreferrer"
                        className="p-4 bg-white/10 rounded-full hover:bg-white hover:text-black transition-all cursor-pointer"
                    >
                        <Instagram size={24} />
                    </a>
                    <a
                    ...
                    <a
                        href="mailto:pumato.feedbacks@gmail.com"
                        className="p-4 bg-white/10 rounded-full hover:bg-white hover:text-black transition-all cursor-pointer"
                    >
                        <Mail size={24} />
                    </a>
                ...
                <div className="flex flex-col items-center justify-center gap-2 opacity-50 relative">
                    <Image
                        ...
                        width={80}
                        height={24}
                        className="h-6 w-auto grayscale mb-1"
                        alt="Logo"
                        unoptimized
                    />
