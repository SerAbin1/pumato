            ...
            <div className="max-w-4xl mx-auto px-4 py-8 pt-24 relative z-10">
                ...
                <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-sm relative overflow-hidden">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-8 font-medium">
                        These Terms & Conditions (&quot;Terms&quot;) govern the use of the PUMATO
                        Laundry Service (&quot;Service&quot;). By placing an order through
                        pumato.online, you (&quot;User&quot; / &quot;Customer&quot;) agree to be
                    ...
                    <div className="space-y-12">
                        <TermBlock title="1. Service Overview">
                            <p>
                                PUMATO Laundry is a pickup and delivery facilitation service
                                operating across multiple campuses and surrounding areas.
                            </p>
                            <p className="mt-4">
                            ...
                            <p className="mt-4">
                                All washing, drying, folding, ironing, stain removal, and garment
                                handling responsibilities are handled entirely by the third-party
                                laundry partner.
                            </p>
                        ...
                        <TermBlock title="2. Order Placement (Website Only)">
                            <p>
                                All laundry orders must be placed exclusively through PUMATO&apos;s
                                official website:
                            </p>
                            <p className="mt-2 text-blue-400 font-bold">🌐 https://pumato.online</p>
                            <p className="mt-4 text-gray-400">
                                Orders placed through WhatsApp, phone calls, or any unofficial
                                channels will not be accepted.
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="3. Prebooking & Slot Selection">
                            ...
                            <p className="mt-4 text-gray-400">
                                PUMATO may reschedule pickup/delivery slots due to operational
                                constraints, weather, or high demand.
                            </p>
                        </TermBlock>

                        <TermBlock title="4. Pickup, Weighing & Payment Policy">
                            <p>
                                Laundry will be weighed at the shop using a weighing scale. Photos
                                of weighing will be sent with payment QR.
                            </p>
                            <p className="mt-4">
                        ...
                        <TermBlock title="5. Pricing & Service Charges">
                            ...
                            <ul className="list-disc pl-5 space-y-2 text-gray-400">
                                <li>
                                    <span className="text-white">Wash + Dry + Fold:</span> ₹79 per
                                    kg
                                </li>
                                <li>
                                    <span className="text-white">Stain Removal:</span> ₹35 per spot
                                </li>
                                <li>
                                    <span className="text-white">Steam Iron:</span> ₹15 per piece
                                </li>
                            </ul>
                            <p className="mt-4 text-gray-400">
                        ...
                        <TermBlock title="6. Delivery Charges">
                            ...
                            <p className="mt-4 text-gray-400">
                                The final delivery fee will be communicated during checkout or
                                confirmation.
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="7. Turnaround Time">
                            <p>
                                The standard turnaround time is{" "}
                                <strong className="text-white">up to 3 business days</strong> from
                                the time of pickup.
                            </p>
                        ...
                        <TermBlock title="8. Prohibited Items Policy (Strict Rule)">
                            <div className="bg-red-500/10 border border-red-500/20 p-6 rounded-2xl">
                                <p className="text-red-400 font-bold mb-2">
                                    For hygiene and safety reasons, the following items are strictly
                                    not accepted:
                                </p>
                                ...
                                <p className="mt-4 text-sm text-red-400/60 font-medium">
                                    If such items are found in the laundry bag, the order may be
                                    rejected immediately, OR the prohibited items may be removed and
                                    returned without processing. No refund will be provided for
                                    delivery charges in such cases.
                                </p>
                            </div>
                        </TermBlock>
                        ...
                        <TermBlock title="9. Valuable Items Disclaimer">
                            <p>
                                Users must not include any valuables inside the laundry bag,
                            ...
                            <p className="mt-4 text-gray-400">
                                PUMATO is not responsible for any loss of valuables left inside
                                laundry bags.
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="10. Missing Items Policy">
                            ...
                            <p className="mt-4 text-gray-400">
                                PUMATO is not responsible for missing items unless the issue is
                                reported immediately at the time of delivery.
                            </p>
                            <p className="mt-2 text-gray-400">
                                Any complaint regarding missing items raised after delivery
                                completion may not be entertained.
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="12. Refund & Service Issue Policy">
                            <p>
                                If a delay occurs solely due to PUMATO&apos;s fault, a partial or
                                full refund of the{" "}
                                <strong className="text-white">delivery fee only</strong> may be
                                issued at PUMATO&apos;s discretion.
                            </p>
                            <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-2xl mt-4">
                                <p className="text-yellow-400">
                                    📌 No refund will be provided for laundry charges, as laundry
                                    processing is handled by a third-party partner.
                                </p>
                            </div>
                        </TermBlock>
                        ...
                        <TermBlock title="13. Rider Access Policy">
                            ...
                            <p className="mt-4 text-gray-400">
                                Users must collect and hand over laundry at the agreed
                        ...
                        <TermBlock title="14. User Conduct">
                            <p>
                                Users must treat PUMATO delivery partners (student workers) with
                                respect.
                            </p>
                            <p className="mt-4">
                                Any of the following may result in immediate suspension or permanent
                                restriction:
                            </p>
                            <ul className="list-disc pl-5 space-y-2 mt-2 text-gray-400">
                        ...
                        <TermBlock title="15. Promotional Offers & Promo Codes">
                            ...
                            <p className="mt-4 text-gray-400">
                                Any attempt to misuse, tamper, or manipulate promo codes through
                                technical or non-technical methods will result in an immediate and
                                permanent ban.
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="16. Limitation of Liability">
                            <p>
                                To the fullest extent permitted by law, PUMATO shall not be liable
                                for:
                            </p>
                            <ul className="list-disc pl-5 space-y-2 mt-2 text-gray-400">
                            ...
                            <p className="mt-4 text-gray-400">
                                PUMATO&apos;s responsibility is strictly limited to logistics
                                facilitation (pickup and delivery).
                            </p>
                        </TermBlock>
                        ...
                        <TermBlock title="18. Modifications to Terms">
                            <p>
                                PUMATO may update or revise these Terms at any time without prior
                                notice. Continued use of the Service constitutes acceptance of the
                                revised Terms.
                            </p>
                        </TermBlock>
                    </div>
