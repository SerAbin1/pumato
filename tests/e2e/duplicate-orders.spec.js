...
import { createTestOrder, updateOrderStatus, cleanupTestData } from "./utils/firebase-helper.js";
...
test.describe("Duplicate Order Detection - Two Duplicates", () => {
    ...
    test("cross-tab duplicate shows 'Duplicate already in Progress' when duplicate is in in-progress tab", async ({
        page,
    }) => {
